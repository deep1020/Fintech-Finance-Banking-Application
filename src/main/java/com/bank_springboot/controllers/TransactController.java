...
import com.bank_springboot.repository.PaymentRepository;
import com.bank_springboot.repository.TransactRepository;
...
public class TransactController {
    ...
    public boolean isBeneficiaryAccountNumberValid(String beneficiaryAccountNumber) {
        int count = accountRepository.countByAccountNumber(beneficiaryAccountNumber);
        System.out.println("Beneficiary Account No. "+beneficiaryAccountNumber);
        return count > 0;
    }
    ...
    public String payment(@RequestParam("beneficiary")String beneficiary,
        ...
        if(!isBeneficiaryAccountNumberValid(account_number)){
            errorMessage = "Invalid Beneficiary Account Number!";
            String reasonCode = "Could not Processed Payment due to Invalid Beneficiary Account Number or Not exist Account Holder!";
...
//        int beneficiaryId = paymentRepository.findBeneficiaryIdBySenderIdAndBeneficiaryAccNo(accountID,account_number);
//        System.out.println("Beneficiary Id: "+beneficiaryId);

        double beneficiarycurrentBalance = accountRepository.getAccountBalancePaymentTo(account_number);
        System.out.println("Beneficiary Current Balance: "+beneficiarycurrentBalance);
        ...
        //---------------------------------//
//        double beneficiaryBalance=paymentRepository.getBeneficiaryBalanceByAccountId(accountID);

        // TODO SET NEW BALANCE FOR ACCOUNT PAYING TO:
        double beneficiaryNewBalance=beneficiarycurrentBalance + paymentAmount;
        System.out.println("Beneficiary New Balance: "+beneficiaryNewBalance);

        // TODO: UPDATE ACCOUNT PAYING TO:
        accountRepository.changeAccountBalanceByAccountNumber(beneficiaryNewBalance,account_number);
        //---------------------------------//
