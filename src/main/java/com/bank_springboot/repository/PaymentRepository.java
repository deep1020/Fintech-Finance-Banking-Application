...
import com.bank_springboot.models.Payment;
...
//            "FROM accounts a " +
//            "JOIN payments p ON a.account_number = p.beneficiary_acc_no " +
//            "WHERE p.account_id = :senderId " +
//            "AND p.beneficiary_acc_no = :beneficiaryAccNo", nativeQuery = true)
//    Integer findBeneficiaryIdBySenderIdAndBeneficiaryAccNo(@Param("senderId") int senderId,
